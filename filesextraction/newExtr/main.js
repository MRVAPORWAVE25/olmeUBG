...
document.querySelectorAll('.panel-btn').forEach(btn => {
  btn.addEventListener('click', (e) => {
    ...
    if (action === 'games') {
      ...
      const targetUrl = 'https://mrvaporwave25.github.io/olmeUBG/filesextraction/newExtr/github-fork-files/game';
    ...
    if (action === 'apps') {
      ...
      const targetUrl = 'https://mrvaporwave25.github.io/olmeUBG/filesextraction/newExtr/github-fork-files/apps';
    ...
    if (action === 'search') {
      ...
      const targetUrl = 'https://mrvaporwave25.github.io/olmeUBG/filesextraction/newExtr/github-fork-files/';
      try {
        createFullscreenIframe(targetUrl);
      } catch (e) {
